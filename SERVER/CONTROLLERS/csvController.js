...
// Router
const generatePlotData2 = async (req, res) => {
...
// Router
const groupByColumn2 = async (req, res) => {
...
const saveAnalysis2 = async (req, res) => {
...
const publishAnalysis2 = async (req, res) => {
...
const getAnalyses2 = async (req, res) => {

              ...
              <li className="px-6 py-4">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="mt-1 text-sm text-gray-500">No surveys available for the selected organizations.</p>
                  </div>
                </div>
              </li>
            </ul>
                ...
                <li key={survey.id} className="px-6 py-4">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="mt-1 text-sm text-gray-500">
                        <strong>Organization:</strong> {survey.organization?.name || 'N/A'}
                      </p>
                    </div>
                  ...
                  <div className="mt-2 sm:flex sm:justify-between">
                    ...
                    <div className="mt-2 sm:mt-0">
                      <p className="text-sm text-gray-500">Created on {formatDate(survey.created_at)}</p>
                    </div>
                  </div>
                </li>
              ))}

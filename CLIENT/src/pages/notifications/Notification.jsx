        ...
        <div className="max-w-7xl mx-auto px-4 py-6 sm:px-6 lg:px-8">
          ...
          <div className="mt-6 border-t border-gray-200 pt-4">
            <nav className="flex space-x-4 overflow-x-auto pb-2">
              <Link 
                to="/dashboard" 
                className="px-3 py-2 text-sm font-medium rounded-md text-gray-600 hover:bg-gray-100 hover:text-gray-900"
              >
                Dashboard
              </Link>
              <Link 
              ...
              <li key={survey.id || survey._id} className="p-4 bg-yellow-50">
                <div className="flex justify-between items-center">
                  ...
                  {survey.is_active ? (
                    ...
                    <span className="px-4 py-2 bg-gray-300 text-gray-700 rounded-md text-sm cursor-not-allowed">
                      Form Unavailable
                    </span>
                  )}
                </div>
